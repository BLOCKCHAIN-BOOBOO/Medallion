  ...
  return (
    ...
    {/* shadow */}
      <div className="container mx-auto relative md:flex md:items-center md:justify-between py-2 md:py-4">
        ...
        <ul
          className="w-full md:w-auto md:flex-row xl:flex-row sm:flex-row flex-col  md:items-center  bg-white sm:bg-white md:bg-transparent lg:bg-transparent absolute z-[1] md:static md:z-auto
